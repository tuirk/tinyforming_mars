...
import type { AILogEntry, GameAction } from '@/engine/types';
...
export function AILogDrawer({ entries, isOpen, onToggle }: AILogDrawerProps) {
    ...
    <div className="w-80 border-l border-border bg-card flex flex-col">
      ...
      <div className="flex items-center justify-between px-3 py-2 border-b border-border">
        <div className="flex items-center gap-2">
          ...
          <span className="font-headline text-sm font-semibold">AI Reasoning Log</span>
        </div>
        <Button
          variant="ghost"
          size="icon"
