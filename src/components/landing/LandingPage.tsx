...
type LegalType = 'disclaimer' | 'privacy' | 'terms';
  ...
  const acceptLegalRow = (
    ...
    >
      <input
        ...
        disabled={loading}
        style={{ marginTop: '2px', accentColor: '#E8872D', flexShrink: 0 }}
      />
      <span>
        I agree to the{' '}
        <button
    ...
    >
      ...
      >
        <div style={{ maxWidth: '380px', flexShrink: 0 }}>
          ...
          >
            Compete against an AI opponent to terraform Mars. Place cities, manage resources, and
            complete projects across generations in this free adaptation of the print-and-play board
            game.
          </p>
          <div style={{ fontSize: '11px', fontFamily: "'Inter', system-ui, sans-serif", marginBottom: '20px' }}>
            <div style={{ display: 'flex', gap: '16px', color: '#5a5a7a', marginBottom: '12px' }}>
              <span>
                <span style={{ color: '#E8872D' }}>●</span> Player vs AI
              </span>
              <span>
                <span style={{ color: '#4CAF50' }}>●</span> Free to play
              </span>
            </div>
            <div
              style={{
          ...
          >
            <span>
              ...
              <a
                href="https://boardgamegeek.com/boardgame/282493/tinyforming-mars"
                target="_blank"
                rel="noopener noreferrer"
                style={{ color: '#E8872D', textDecoration: 'none', fontWeight: 500 }}
              >
                Michael Bevilacqua
              </a>
            </span>
        ...
        >
          ...
          {showForgot ? (
            resetSent ? (
              <div style={{ textAlign: 'center', padding: '12px 0' }}>
                ...
                <p style={{ fontSize: '12px', color: '#8a8aaa' }}>
              ...
              <form onSubmit={handleReset} style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                ...
                <div style={{ display: 'flex', gap: '8px' }}>
                  <button
                    ...
                    style={{ ...inputStyle, cursor: 'pointer', textAlign: 'center', background: '#1a1a2e' }}
                  >
                    Cancel
                  </button>
                  <button
            ...
            <form onSubmit={handleSignUp} style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              ...
              <button
                ...
                style={{
                  ...
                  fontWeight: 500,
                  letterSpacing: '1px',
                  cursor: loading || !acceptedLegal ? 'not-allowed' : 'pointer',
                  opacity: loading || !acceptedLegal ? 0.55 : 1,
                }}
              >
          ...
          {!showForgot && (
            <>
              ...
              {tab === 'signin' && <div style={{ marginBottom: '10px' }}>{acceptLegalRow}</div>}
              ...
              <p style={{ fontSize: '10px', color: '#5a5a7a', textAlign: 'center', marginTop: '10px' }}>
                No account needed to play — accept Terms & Privacy above
              </p>
            </>
          )}
        </div>
